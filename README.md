# alexisIPTV - IPTV Player Application

<p align="center">
  <img src="https://raw.githubusercontent.com/4gray/iptvnator/electron/src/assets/icons/favicon.256x256.png" alt="alexisIPTV icon" title="Free IPTV player application" />
</p>
<p align="center">
...
```shell
$ brew install alexisIPTV
```

### Snap

```shell
$ sudo snap install alexisIPTV
```
...
```shell
$ yay -S alexisIPTV-bin
```

### Gentoo

You can install alexisIPTV from the [gentoo-zh overlay](https://github.com/microcai/gentoo-zh)

```shell
sudo eselect repository enable gentoo-zh
sudo emerge --sync gentoo-zh
sudo emerge alexisIPTV-bin
```
...
**alexisIPTV doesn't provide any playlists or other digital content.**
