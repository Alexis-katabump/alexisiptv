# Self-hosted version of alexisIPTV

You can deploy and run the PWA version of alexisIPTV on your own machine with `docker-compose` using the following command:
